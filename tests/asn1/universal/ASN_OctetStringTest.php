...
class ASN_OctetStringTest extends PHPASN1TestCase {

    public function testGetType() {
        $object = new ASN_OctetString('30 14 06 08 2B 06 01 05 05 07 03 01 06 08 2B 06 01 05 05 07 03 02');
        $this->assertEquals(Identifier::OCTETSTRING, $object->getType());
    }
    
    public function testContent() {
        $object = new ASN_OctetString('A01200C3');
        $this->assertEquals('A01200C3', $object->getContent());
        
        $object = new ASN_OctetString('A0 12 00 C3');
        $this->assertEquals('A01200C3', $object->getContent());
        ...
        $object = new ASN_OctetString(0xA01200C3);
        $this->assertEquals('A01200C3', $object->getContent());
    }
    
    public function testGetObjectLength() {
        $object = new ASN_OctetString(0x00);
        $this->assertEquals(3, $object->getObjectLength());
        
        $object = new ASN_OctetString(0xFF);
        $this->assertEquals(3, $object->getObjectLength());
        
        $object = new ASN_OctetString(0xA000);
        $this->assertEquals(4, $object->getObjectLength());
        
        $object = new ASN_OctetString(0x3F2001);
    ...
    public function testGetObjectLengthWithVeryLongOctetString() {
        ...
        $object = new ASN_OctetString($hexString);
    ...
    public function testGetBinary() {
        ...
        $object = new ASN_OctetString(0xFFA034);
    ...
    public function testFromBinary() {        
        $originalobject = new ASN_OctetString(0x12);
        $binaryData = $originalobject->getBinary();
        $parsedObject = ASN_OctetString::fromBinary($binaryData);
        $this->assertEquals($originalobject, $parsedObject);
        
        $originalobject = new ASN_OctetString(0x010203A0);
        $binaryData = $originalobject->getBinary();
        $parsedObject = ASN_OctetString::fromBinary($binaryData);
        $this->assertEquals($originalobject, $parsedObject);         
    }
    ...
    public function testFromBinaryWithOffset() {
        $originalobject1 = new ASN_OctetString(0xA0);
        $originalobject2 = new ASN_OctetString(0x314510);
        
        $binaryData  = $originalobject1->getBinary();
        $binaryData .= $originalobject2->getBinary();
        
        $offset = 0;        
        $parsedObject = ASN_OctetString::fromBinary($binaryData, $offset);
