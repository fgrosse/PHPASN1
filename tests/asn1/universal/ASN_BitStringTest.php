...
class ASN_BitStringTest extends PHPASN1TestCase {
    ...
    public function testContent() {
        $object = new ASN_BitString('A01200C3');
        $this->assertEquals('A01200C3', $object->getContent());
        
        $object = new ASN_BitString('A0 12 00 C3');
        $this->assertEquals('A01200C3', $object->getContent());
        ...
        $object = new ASN_BitString(0xA01200C3);
        $this->assertEquals('A01200C3', $object->getContent());
    }
    
    public function testGetObjectLength() {
        $object = new ASN_BitString(0x00);
        $this->assertEquals(4, $object->getObjectLength());
        
        $object = new ASN_BitString(0xFF);
        $this->assertEquals(4, $object->getObjectLength());
        
        $object = new ASN_BitString(0xA000);
    ...
    public function testGetBinary() {
        ...
        $object = new ASN_BitString(0xFFA034);
        ...
        $object = new ASN_BitString(0xA8, 3);
        $expectedLength = chr(0x02);
    ...
    public function testFromBinary() {        
        $originalobject = new ASN_BitString(0x12);
    ...
    public function testFromBinaryWithOffset() {
        $originalobject1 = new ASN_BitString(0xA0);
        $originalobject2 = new ASN_BitString(0x314510);
        
        $binaryData  = $originalobject1->getBinary();
        $binaryData .= $originalobject2->getBinary();
        
        $offset = 0;        
        $parsedObject = ASN_BitString::fromBinary($binaryData, $offset);
     ...
     * @expectedExceptionMessage ASN.1 Parser Exception at offset 2: A PHPASN1\ASN_BitString should have a content length of at least 2. Extracted length was 1
     * @depends testFromBinary
     */
