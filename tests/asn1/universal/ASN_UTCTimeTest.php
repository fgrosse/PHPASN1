...
class UTCTimeTest extends PHPASN1TestCase {
    ...
    public function testGetContent() {
        ...
        $object = new ASN_UTCTime($timeString);
        $content = $object->getContent();
        $this->assertTrue($content instanceof \DateTime);
    ...
    public function testGetObjectLength() {
        ...
        $object = new ASN_UTCTime('2012-09-23');
        $this->assertEquals($expectedSize, $object->getObjectLength());
        
        $object = new ASN_UTCTime('1987-01-15 12:12:16');
        $this->assertEquals($expectedSize, $object->getObjectLength());
    }
    ...
    public function testGetBinary() {
        ...
        $object = new ASN_UTCTime($dateString);
    ...
    public function testFromBinaryWithDEREncoding() {
        ...
        $parsedObject = ASN_UTCTime::fromBinary($binaryData);
    ...
    public function testFromBinaryWithOffset() {
        ...
        $offset = 0;
        $parsedObject = ASN_UTCTime::fromBinary($binaryData, $offset);        
    ...
    public function testToString() {
        ...
        $object = new ASN_UTCTime('2012-09-23 22:13:43');
