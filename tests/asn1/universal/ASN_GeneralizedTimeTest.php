...
class ASN_GeneralizedTimeTest extends PHPASN1TestCase {
    ...
    public function testGetType() {        
        $object = new ASN_GeneralizedTime();
    ...
    public function testGetContent() {
        ...
        $object = new ASN_GeneralizedTime($timeString);
        $content = $object->getContent();
        $this->assertTrue($content instanceof \DateTime);
    ...
    public function testGetObjectLength() {
        ...
        $object = new ASN_GeneralizedTime('2012-09-23');
        $this->assertEquals($expectedSize, $object->getObjectLength());
        
        // with fractional-seconds elements
        $object = new ASN_GeneralizedTime('2012-09-23 22:21:03.5435440');
    ...
    public function testGetBinary() {
        ...
        $object = new ASN_GeneralizedTime($dateString);
    ...
    public function testFromBinaryWithDEREncoding() {
        ...
        $parsedObject = ASN_GeneralizedTime::fromBinary($binaryData);
