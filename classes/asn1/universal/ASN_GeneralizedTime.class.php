 ...
 */
class ASN_GeneralizedTime extends ASN_AbstractTime implements Parseable {
        ...
        if($contentLength == $lengthOfMinimumTimeString) {
            ...
            if($maximumBytesToRead > 0 ) {
                ...
                || $binaryData[$offsetIndex] == '-') {
                    ...
                    throw new ASN1ParserException('Invalid ISO 8601 Time String', $offsetIndex);
                }
            }
        }
        
        $parsedObject = new ASN_GeneralizedTime($dateTime);
