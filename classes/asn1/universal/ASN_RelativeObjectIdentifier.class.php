...
class ASN_RelativeObjectIdentifier extends ASN_ObjectIdentifier implements Parseable {
    ...
    public static function fromBinary(&$binaryData, &$offsetIndex=0) {
        ...
        while($octetsToRead > 0) {
            ...
            do {
                if($octetsToRead == 0) {
                    throw new ASN1ParserException('Malformed ASN.1 Relative Object Identifier', $offsetIndex-1);
                }
