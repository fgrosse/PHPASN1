...
class ASN_OctetString extends ASN_Object implements Parseable {
    ...
    public function __construct($value) {
        if(is_string($value)) {
            ...
            throw new Exception("ASN_OctetString: unrecognized input type!");
        }
    ...
    public static function fromBinary(&$binaryData, &$offsetIndex=0) {                
        ...
        $parsedObject = new ASN_OctetString(bin2hex($value));
